...
final class NetworkLayer {
    ...
    public func getCharacters(page: Int) async throws -> CharacterGroup {
        guard let url = ApiRouter.getCharacters(page: page).url else { throw ApiError.invalidURL }
    ...
    public func getEpisodes(page: Int) async throws -> EpisodesGroup {
        guard let url = ApiRouter.getEpisodes(page: page).url else { throw ApiError.invalidURL }
    ...
    public func getLocations(page: Int) async throws -> LocationsGroup {
        guard let url = ApiRouter.getLocations(page: page).url else { throw ApiError.invalidURL }
